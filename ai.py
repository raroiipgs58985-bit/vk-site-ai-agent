...
class OpenRouterClient:
    ...
    def plan_queries(self, question: str) -> QueryPlan:
        system = (
            ...
            "и имена сущностей. Для терминов Warhammer 40,000 сохраняй официальные "
            "английские названия и добавляй вероятные синонимы. Формат: "
    ...
    def compose_answer(
        ...
        *,
        ...
        system = (
            ...
            "свои знания для заполнения пробелов. Если прямого подтверждения нет, так и "
            "напиши. Не подменяй отсутствие упоминания утверждением, что событие никогда "
            "не происходило. Ссылайся на номера источников. Верни только JSON формата: "
